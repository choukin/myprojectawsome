...
function drawBasePoster(data?:any) {
  return {
    width: '654px',
    height: '1000px',
    background: '#eee',
...
function _textDecoration(decoration:string, index:number, color?:string) {
  return {
    type: 'text',
    text: decoration,
    css: [
...
function _image(index:number, rotate?:number, borderRadius?:string) {
  return {
    type: 'image',
...
function _des(index:number, content:string) {
  const des:any = {
    type: 'text',
    text: content,
    css: {
...
function drawImgPoster(data:any) {
  return {
    width: '654px',
    height: '1140px',
    background: '#eee',
