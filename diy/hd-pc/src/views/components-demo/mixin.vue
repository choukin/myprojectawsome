...
<script>
import PanThumb from '@/mobile/components/PanThumb'
import MdInput from '@/mobile/components/MDinput'
import Mallki from '@/mobile/components/TextHoverEffect/Mallki'
